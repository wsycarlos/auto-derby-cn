...
Start-Transcript "$WorkspaceFolder\launcher_zh-tw.log"
...
if ($data.Debug) {   
    ...
    $env:AUTO_DERBY_WEB_LOG_DISABLED = "false"
...
$env:AUTO_DERBY_SINGLE_MODE_TARGET_DISTANCE = $data.Distance
...
set "AUTO_DERBY_SINGLE_MODE_TARGET_DISTANCE=$($env:AUTO_DERBY_SINGLE_MODE_TARGET_DISTANCE)"
...
start "auto-derby launcher" cmd.exe /c .\launcher_zh-tw.cmd
exit
"@
